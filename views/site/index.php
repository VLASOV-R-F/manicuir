...
?>
              ...
              <div class="box-service-modern">
                <div class="box-icon-classic box-icon-classic-vertical">
                  <div class="icon-classic-aside">
                    ...
                    <h4 class="icon-classic-title"><a href="services.html">Маникюр</a></h4>
                  </div>
                  <div class="icon-classic-body">
                    <p>Наши маникюрные процедуры стимулируют рост ногтей и смягчают сухую, тусклую кожу.</p>
                  </div>
                </div>
              ...
              <div class="box-service-modern box-service-modern-reverse">
                <div class="box-icon-classic box-icon-classic-vertical">
                  <div class="icon-classic-aside">
                    ...
                    <h4 class="icon-classic-title"><a href="services.html">Педикюр</a></h4>
                  </div>
                  <div class="icon-classic-body">
                    <p>Услуги педикюра обеспечивают полное восстановление ногтей с дополнительной полировкой и рефолиацией кожи.</p>
                  </div>
                </div>
              ...
              <div class="box-service-modern">
                <div class="box-icon-classic box-icon-classic-vertical">
                  <div class="icon-classic-aside">
                    ...
                    <h4 class="icon-classic-title"><a href="services.html">Декор</a></h4>
                  </div>
                  <div class="icon-classic-body">
                    <p>Пусть наши художники ногтей создать потрясающий и устойчивый дизайн ногтей для вас.</p>
                  </div>
                </div>
            ...
            <div class="row row-30 counter-list-border">
              ...
              <div class="col-6 col-md-3">
                ...
                <article class="box-counter">
                  ...
                  <p class="box-counter-title">Наград</p>
                </article>
              </div>
              <div class="col-6 col-md-3">
                <!-- Box counter-->
                <article class="box-counter">
                  <div class="box-counter-main">
                    <div class="counter heading-1">543</div>
                  </div>
                  <p class="box-counter-title">Дизайнов</p>
                </article>
              </div>
              <div class="col-6 col-md-3">
                <!-- Box counter-->
                <article class="box-counter">
                  ...
                  <p class="box-counter-title">Новых идей</p>
                </article>
              </div>
            </div>
          </div>
      ...
      <section class="section">
        <script type="text/javascript" charset="utf-8" async src="https://api-maps.yandex.ru/services/constructor/1.0/js/?um=constructor%3Addb9fb5636ebd3828050fef1584e268b7cdb34b32c34769699ee62cfcdc12001&amp;width=100%25&amp;height=500&amp;lang=ru_RU&amp;scroll=true"></script>
      </section>